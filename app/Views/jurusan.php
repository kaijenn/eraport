    ...
    <span class="mdi mdi-plus"></span> Tambah Jurusan
              ...
              ?>
                <tr>
                  ...
                  <td>
                  <button class="btn btn-warning" data-toggle="modal" data-target="#editPaketModal" onclick="editPaket(<?= $key->id_jurusan ?>, '<?= $key->nama_jurusan ?>')">
                    Edit
                </button>
                <a href="<?= base_url('home/hapus_jurusan/' . $key->id_jurusan) ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="editPaketForm" action="<?= base_url('home/aksi_e_jurusan') ?>" method="post">
...
<div class="modal fade" id="tambahPaketModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="tambahPaketForm" action="<?= base_url('home/aksi_t_jurusan') ?>" method="post">
        <div class="modal-body">
          <div class="form-group">
            <label for="nama_jurusan">Nama Jurusan</label>
            <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" required>

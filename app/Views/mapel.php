    ...
    <span class="mdi mdi-plus"></span> Tambah Mapel
              ...
              ?>
                <tr>
                  ...
                  <td>
                  <button class="btn btn-warning" data-toggle="modal" data-target="#editPaketModal" onclick="editPaket(<?= $key->id_mapel ?>, '<?= $key->nama_mapel ?>', '<?= $key->kkm ?>')">

                    Edit
                </button>
                <a href="<?= base_url('home/hapus_mapel/' . $key->id_mapel) ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="editPaketForm" action="<?= base_url('home/aksi_e_mapel') ?>" method="post">
...
<div class="modal fade" id="tambahPaketModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="tambahPaketForm" action="<?= base_url('home/aksi_t_mapel') ?>" method="post">
        <div class="modal-body">
          <div class="form-group">
            <label for="nama_mapel">Nama Mapel</label>
            <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" required>
...
<script>
  function editPaket(id, nama, kkm) {
